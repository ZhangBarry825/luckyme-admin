<template>
  <div class="content-mytype">
    <mConsole :article-type="articleType" @handleCreate="handleCreate" @handleDelete="consoleDelete"
              @handleSearch="handleSearch"/>
    <mTable ref="mtable" :typeList="typeList" :table-data="tableData" :all-num="allNum" :is-loading="isLoading"
            @handleDelete="tableDelete" @handleSelect="handleSelect" @handleEdit="handleEdit" @pageChange="tableLoad"/>
  </div>
</template>
